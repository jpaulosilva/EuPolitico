...
function FrameVisualizarCandidato:inicialize()
  ...
  if (CenaBuscaCandidatos.escolaSelecionada ~= nil and not CenaBuscaCandidatos.isCarregandoDetalhes) then
...
function FrameVisualizarCandidato:buildPainelDetalhes()
  ...
  local panelDetalhesEscola= TPanel.new();
  panelDetalhesEscola:setLargura(1270);
  panelDetalhesEscola:setAltura(645);
  panelDetalhesEscola:setPx(5);
  panelDetalhesEscola:setPy(5);
  panelDetalhesEscola:setCorFundo(Cor.new({r=0,g=255,b=0,alpha=120}))--{r=200,g=255,b=255,alpha=255})); --{r=153,g=204,b=51,alpha=255}))



  local labelEscola = TLabel.new();
  labelEscola:setTexto("Escola");
  labelEscola:setFonte(font_destaque);
  labelEscola:setPx(0);
  labelEscola:setPy(0);
  panelDetalhesEscola:addComponent(labelEscola,1);
  ...
  local cod = tostring(CenaBuscaCandidatos.escolaSelecionada:getCod());
  ...
  local nome = tostring(CenaBuscaCandidatos.escolaSelecionada:getNome());
  ...
  panelDetalhesEscola:addComponent(fieldNome,3);
  ...
  local regiao = tostring(CenaBuscaCandidatos.escolaSelecionada:getRegiao());
  ...
  local estado = tostring(CenaBuscaCandidatos.escolaSelecionada:getEstado());
  ...
  local cidade = tostring(CenaBuscaCandidatos.escolaSelecionada:getCidade());
  ...
  local endereco = tostring(CenaBuscaCandidatos.escolaSelecionada:getEndereco());
  ...
  local tipoLocalizacaoTxt = tostring(CenaBuscaCandidatos.escolaSelecionada:getTipoLocalizacao());
  ...
  local cod = tostring(CenaBuscaCandidatos.escolaSelecionada:getDependenciaAdministrativa());
  ...
  local idebAi = tostring(CenaBuscaCandidatos.escolaSelecionada:getIdebAI());
  ...
  local idebAf = tostring(CenaBuscaCandidatos.escolaSelecionada:getIdebAF());
  ...
  local regulamentada = tostring(CenaBuscaCandidatos.escolaSelecionada:getRegulamentada());
  ...
  local situacaoFuncionamento = tostring(CenaBuscaCandidatos.escolaSelecionada:getSituacaoFuncionamento());
  ...
  local inicioAno = tostring(CenaBuscaCandidatos.escolaSelecionada:getInicioAno());
  ...
  local fimAno = tostring(CenaBuscaCandidatos.escolaSelecionada:getFimAno());
  ...
  local enemGeral = tostring(CenaBuscaCandidatos.escolaSelecionada:getEnemGeral());
  ...
  local aguaPublica = tostring(CenaBuscaCandidatos.escolaSelecionada:getAguaPublica());
  ...
  local aguaPocoArtesiano = tostring(CenaBuscaCandidatos.escolaSelecionada:getAguaPocoArtesiano());
  ...
  local aguaCacimba = tostring(CenaBuscaCandidatos.escolaSelecionada:getAguaCacimba());
  ...
  local aguaRio = tostring(CenaBuscaCandidatos.escolaSelecionada:getAguaCacimba());
  ...
  local aguaInexistente = tostring(CenaBuscaCandidatos.escolaSelecionada:getAguaInexistente());
  ...
  local energiaPublica = tostring(CenaBuscaCandidatos.escolaSelecionada:getEnergiaPublica());
  ...
  local energiaGerador = tostring(CenaBuscaCandidatos.escolaSelecionada:getEnergiaGerador());
  ...
  local energiaOutros = tostring(CenaBuscaCandidatos.escolaSelecionada:getEnergiaGerador());
  ...
  local energiaInexistente = tostring(CenaBuscaCandidatos.escolaSelecionada:getEnergiaInexistente());
  ...
  local esgotoPublico = tostring(CenaBuscaCandidatos.escolaSelecionada:getEsgotoPublico());
  ...
  local esgotoFossa = tostring(CenaBuscaCandidatos.escolaSelecionada:getEsgotoFossa());
  ...
  local esgotoInexistente = tostring(CenaBuscaCandidatos.escolaSelecionada:getEsgotoInexistente());
  ...
  local lixoColetaPeriodica = tostring(CenaBuscaCandidatos.escolaSelecionada:getLixoColetaPeriodica());
  ...
  local lixoQueima = tostring(CenaBuscaCandidatos.escolaSelecionada:getLixoQueima());
  ...
  local lixoJogaOutraArea = tostring(CenaBuscaCandidatos.escolaSelecionada:getLixoJogaOutraArea());
  ...
  local lixoRecicla = tostring(CenaBuscaCandidatos.escolaSelecionada:getLixoRecicla());
  ...
  local lixoEnterra = tostring(CenaBuscaCandidatos.escolaSelecionada:getLixoEnterra());
  ...
  local lixoOutros = tostring(CenaBuscaCandidatos.escolaSelecionada:getLixoOutros());
  ...
  local aguaFiltrada = tostring(CenaBuscaCandidatos.escolaSelecionada:getAguaFiltrada());
  ...
  local salaDiretoria = tostring(CenaBuscaCandidatos.escolaSelecionada:getSalaDiretoria());
  ...
  local labInformatica = tostring(CenaBuscaCandidatos.escolaSelecionada:getLaboratorioInformatica());
  ...
  local biblioteca = tostring(CenaBuscaCandidatos.escolaSelecionada:getBiblioteca());
  ...
  local labCiencias = tostring(CenaBuscaCandidatos.escolaSelecionada:getLaboratorioCiencias());
  ...
  local salaLeitura = tostring(CenaBuscaCandidatos.escolaSelecionada:getSalaLeitura());
  ...
  local despensa = tostring(CenaBuscaCandidatos.escolaSelecionada:getDespensa());
  ...
  local refeitorio = tostring(CenaBuscaCandidatos.escolaSelecionada:getRefeitorio());
  ...
  local almoxarifado = tostring(CenaBuscaCandidatos.escolaSelecionada:getAlmoxarifado());
  ...
  local auditorio = tostring(CenaBuscaCandidatos.escolaSelecionada:getAuditorio());
  ...
  local patioCoberto = tostring(CenaBuscaCandidatos.escolaSelecionada:getPatioCoberto());
  ...
  local areaVerde = tostring(CenaBuscaCandidatos.escolaSelecionada:getAreaVerde());
  ...
  local lavanderia = tostring(CenaBuscaCandidatos.escolaSelecionada:getLavanderia());
  ...
  local salaProfessores = tostring(CenaBuscaCandidatos.escolaSelecionada:getSalaProfessores());
  ...
  local atendimentoEspecial = tostring(CenaBuscaCandidatos.escolaSelecionada:getAtendimentoEspecial());
  ...
  local quadraCoberta = tostring(CenaBuscaCandidatos.escolaSelecionada:getQuadraCoberta());
  ...
  local cozinha = tostring(CenaBuscaCandidatos.escolaSelecionada:getCozinha());
  ...
  local parqueInfantil = tostring(CenaBuscaCandidatos.escolaSelecionada:getParqueInfantil());
  ...
  local bercario = tostring(CenaBuscaCandidatos.escolaSelecionada:getBercario());
  ...
  local secretaria = tostring(CenaBuscaCandidatos.escolaSelecionada:getSecretaria());
  ...
  local sanitarioForaPredio = tostring(CenaBuscaCandidatos.escolaSelecionada:getSanitarioForaPredio());
  ...
  local sanitarioDentroPredio = tostring(CenaBuscaCandidatos.escolaSelecionada:getSanitarioDentroPredio());
  ...
  local dependenciasPNE = tostring(CenaBuscaCandidatos.escolaSelecionada:getDependenciasPNE());
  ...
  local banheiroChuveiro = tostring(CenaBuscaCandidatos.escolaSelecionada:getBanheiroChuveiro());
  ...
  local alojamentoAluno = tostring(CenaBuscaCandidatos.escolaSelecionada:getAlojamentoAluno());
...
function FrameVisualizarCandidato:action(evt)
  ...
  elseif(BibliotecaAuxiliarEvento.isEventoControle(evt) and BibliotecaAuxiliarEvento.isBotaoVerde(evt)) then
    ...
    CenaBuscaCandidatos.filtroRegional:setRegiaoGeografica(CenaBuscaCandidatos.escolaSelecionada:getRegiao());
    CenaBuscaCandidatos.filtroEstadual:setEstado(CenaBuscaCandidatos.escolaSelecionada:getEstado());
    CenaBuscaCandidatos.filtroMunicipal:setCidade(CenaBuscaCandidatos.escolaSelecionada:getCodMunicipio());
