...
function FrameVisualizarPolitico:inicialize()
  ...
  if (CenaBusca.escolaSelecionada ~= nil and not CenaBusca.isCarregandoDetalhes) then
...
function FrameVisualizarPolitico:buildPainelDetalhes()
  ...
  local cod = tostring(CenaBusca.escolaSelecionada:getCod());
  ...
  local nome = tostring(CenaBusca.escolaSelecionada:getNome());
  ...
  local regiao = tostring(CenaBusca.escolaSelecionada:getRegiao());
  ...
  local estado = tostring(CenaBusca.escolaSelecionada:getEstado());
  ...
  local cidade = tostring(CenaBusca.escolaSelecionada:getCidade());
  ...
  local endereco = tostring(CenaBusca.escolaSelecionada:getEndereco());
  ...
  local tipoLocalizacaoTxt = tostring(CenaBusca.escolaSelecionada:getTipoLocalizacao());
  ...
  local cod = tostring(CenaBusca.escolaSelecionada:getDependenciaAdministrativa());
  ...
  local idebAi = tostring(CenaBusca.escolaSelecionada:getIdebAI());
  ...
  local idebAf = tostring(CenaBusca.escolaSelecionada:getIdebAF());
  ...
  local regulamentada = tostring(CenaBusca.escolaSelecionada:getRegulamentada());
  ...
  local situacaoFuncionamento = tostring(CenaBusca.escolaSelecionada:getSituacaoFuncionamento());
  ...
  local inicioAno = tostring(CenaBusca.escolaSelecionada:getInicioAno());
  ...
  local fimAno = tostring(CenaBusca.escolaSelecionada:getFimAno());
  ...
  local enemGeral = tostring(CenaBusca.escolaSelecionada:getEnemGeral());
  ...
  local aguaPublica = tostring(CenaBusca.escolaSelecionada:getAguaPublica());
  ...
  local aguaPocoArtesiano = tostring(CenaBusca.escolaSelecionada:getAguaPocoArtesiano());
  ...
  local aguaCacimba = tostring(CenaBusca.escolaSelecionada:getAguaCacimba());
  ...
  local aguaRio = tostring(CenaBusca.escolaSelecionada:getAguaCacimba());
  ...
  local aguaInexistente = tostring(CenaBusca.escolaSelecionada:getAguaInexistente());
  ...
  local energiaPublica = tostring(CenaBusca.escolaSelecionada:getEnergiaPublica());
  ...
  local energiaGerador = tostring(CenaBusca.escolaSelecionada:getEnergiaGerador());
  ...
  local energiaOutros = tostring(CenaBusca.escolaSelecionada:getEnergiaGerador());
  ...
  local energiaInexistente = tostring(CenaBusca.escolaSelecionada:getEnergiaInexistente());
  ...
  local esgotoPublico = tostring(CenaBusca.escolaSelecionada:getEsgotoPublico());
  ...
  local esgotoFossa = tostring(CenaBusca.escolaSelecionada:getEsgotoFossa());
  ...
  local esgotoInexistente = tostring(CenaBusca.escolaSelecionada:getEsgotoInexistente());
  ...
  local lixoColetaPeriodica = tostring(CenaBusca.escolaSelecionada:getLixoColetaPeriodica());
  ...
  local lixoQueima = tostring(CenaBusca.escolaSelecionada:getLixoQueima());
  ...
  local lixoJogaOutraArea = tostring(CenaBusca.escolaSelecionada:getLixoJogaOutraArea());
  ...
  local lixoRecicla = tostring(CenaBusca.escolaSelecionada:getLixoRecicla());
  ...
  local lixoEnterra = tostring(CenaBusca.escolaSelecionada:getLixoEnterra());
  ...
  local lixoOutros = tostring(CenaBusca.escolaSelecionada:getLixoOutros());
  ...
  local aguaFiltrada = tostring(CenaBusca.escolaSelecionada:getAguaFiltrada());
  ...
  local salaDiretoria = tostring(CenaBusca.escolaSelecionada:getSalaDiretoria());
  ...
  local labInformatica = tostring(CenaBusca.escolaSelecionada:getLaboratorioInformatica());
  ...
  local biblioteca = tostring(CenaBusca.escolaSelecionada:getBiblioteca());
  ...
  local labCiencias = tostring(CenaBusca.escolaSelecionada:getLaboratorioCiencias());
  ...
  local salaLeitura = tostring(CenaBusca.escolaSelecionada:getSalaLeitura());
  ...
  local despensa = tostring(CenaBusca.escolaSelecionada:getDespensa());
  ...
  local refeitorio = tostring(CenaBusca.escolaSelecionada:getRefeitorio());
  ...
  local almoxarifado = tostring(CenaBusca.escolaSelecionada:getAlmoxarifado());
  ...
  local auditorio = tostring(CenaBusca.escolaSelecionada:getAuditorio());
  ...
  local patioCoberto = tostring(CenaBusca.escolaSelecionada:getPatioCoberto());
  ...
  local areaVerde = tostring(CenaBusca.escolaSelecionada:getAreaVerde());
  ...
  local lavanderia = tostring(CenaBusca.escolaSelecionada:getLavanderia());
  ...
  local salaProfessores = tostring(CenaBusca.escolaSelecionada:getSalaProfessores());
  ...
  local atendimentoEspecial = tostring(CenaBusca.escolaSelecionada:getAtendimentoEspecial());
  ...
  local quadraCoberta = tostring(CenaBusca.escolaSelecionada:getQuadraCoberta());
  ...
  local cozinha = tostring(CenaBusca.escolaSelecionada:getCozinha());
  ...
  local parqueInfantil = tostring(CenaBusca.escolaSelecionada:getParqueInfantil());
  ...
  local bercario = tostring(CenaBusca.escolaSelecionada:getBercario());
  ...
  local secretaria = tostring(CenaBusca.escolaSelecionada:getSecretaria());
  ...
  local sanitarioForaPredio = tostring(CenaBusca.escolaSelecionada:getSanitarioForaPredio());
  ...
  local sanitarioDentroPredio = tostring(CenaBusca.escolaSelecionada:getSanitarioDentroPredio());
  ...
  local dependenciasPNE = tostring(CenaBusca.escolaSelecionada:getDependenciasPNE());
  ...
  local banheiroChuveiro = tostring(CenaBusca.escolaSelecionada:getBanheiroChuveiro());
  ...
  local alojamentoAluno = tostring(CenaBusca.escolaSelecionada:getAlojamentoAluno());
...
function FrameVisualizarPolitico:action(evt)
  ...
  elseif(BibliotecaAuxiliarEvento.isEventoControle(evt) and BibliotecaAuxiliarEvento.isBotaoVerde(evt)) then
    ...
    CenaBusca.filtroRegional:setRegiaoGeografica(CenaBusca.escolaSelecionada:getRegiao());
    CenaBusca.filtroEstadual:setEstado(CenaBusca.escolaSelecionada:getEstado());
    CenaBusca.filtroMunicipal:setCidade(CenaBusca.escolaSelecionada:getCodMunicipio());
