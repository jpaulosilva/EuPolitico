...
ObserverComponent =  {
  ...
  handler = function(evt)
    ...
    (
        (
          (BibliotecaAuxiliarEvento.isEventoControle(evt) and BibliotecaAuxiliarEvento.isEventoRelease(evt)) or
           BibliotecaAuxiliarEvento.isEventoUsuario(evt)
        ) and Display.currentFrame ~= nil
    ) then
